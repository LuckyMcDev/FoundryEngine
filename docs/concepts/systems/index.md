...
FoundryEngine provides a collection of game-engine-style systems that run alongside Minecraft.
...
- [Mesh Rendering and OBJ](mesh-rendering) -- Custom mesh rendering engine, OBJ model loading, and pipeline system
