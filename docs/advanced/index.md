...
These pages are for Java developers who want to extend FoundryEngine beyond bundle scripting.

| Page                                        | What it covers                                       |
|---------------------------------------------|------------------------------------------------------|
| [Java Addon API](addon-api.md)              | Events and builders for Java addon developers        |
