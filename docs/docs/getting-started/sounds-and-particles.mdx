...
Put the audio file at `src/main/resources/assets/mybundle/sounds/magic_chime.ogg`. The file name matches the path you passed to `addSound`. The example bundle uses an OGG file; that is the format Minecraft expects by default.
