...
public class EntityEvents {
    public static final EventGroupHolder<EntityJoinLevelEvent> JOIN_LEVEL = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_ENTITY_JOIN_LEVEL);
    public static final EventGroupHolder<LivingDeathEvent> DEATH = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_LIVING_DEATH);
    public static final EventGroupHolder<LivingDropsEvent> DROPS = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_LIVING_DROPS);
    public static final EventGroupHolder<LivingDamageEvent.Post> HURT = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_LIVING_HURT);
    public static final EventGroupHolder<EntityJoinLevelEvent> SPAWNED = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_ENTITY_JOIN_LEVEL);
    public static final EventGroupHolder<EntityJoinLevelEvent> CHECK_SPAWN = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_ENTITY_JOIN_LEVEL);
