...
public class BlockEvents {
    public static final EventGroupHolder<BreakBlockEvent> BROKEN = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_BLOCK_BROKEN);
    public static final EventGroupHolder<BlockEvent.EntityPlaceEvent> PLACED = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_BLOCK_PLACED);
    public static final EventGroupHolder<BlockEvent.NeighborNotifyEvent> NEIGHBOR_NOTIFY = new EventGroupHolder<>();
    public static final EventGroupHolder<PlayerInteractEvent.LeftClickBlock> LEFT_CLICKED = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_BLOCK_LEFT_CLICKED);
    public static final EventGroupHolder<PlayerInteractEvent.RightClickBlock> RIGHT_CLICKED = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_BLOCK_RIGHT_CLICKED);
    public static final EventGroupHolder<BlockEvent.FarmlandTrampleEvent> FARMLAND_TRAMPLED = new EventGroupHolder<>(BlueprintEngine.BuiltinNodes.EVENT_FARMLAND_TRAMPLED);
