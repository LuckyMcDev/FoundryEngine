...
public class AreaPanel extends EditorPanel {
	...
	private void renderCreateFormSplitter() {
		...
		if (ImGui.isItemActive()) {
			...
			if (createFormHeight < CREATE_FORM_MIN_HEIGHT) {
				createFormHeight = CREATE_FORM_MIN_HEIGHT;
			}
			if (createFormHeight > CREATE_FORM_MAX_HEIGHT) {
				createFormHeight = CREATE_FORM_MAX_HEIGHT;
			}
		}
