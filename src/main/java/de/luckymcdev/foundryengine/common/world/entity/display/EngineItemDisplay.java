...
public class EngineItemDisplay extends Display.ItemDisplay implements EngineDisplay {
    ...
    private void refreshHitbox() {
        ...
        hitboxBounds = DisplayHitboxUtil.forItem(new Transformation(
    ...
    public @Nullable String getOffhandInteractionCommand() {
        return offHandInteractionCommand;
    }
