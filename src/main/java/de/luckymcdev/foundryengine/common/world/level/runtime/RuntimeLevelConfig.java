...
import de.luckymcdev.foundryengine.common.world.level.util.GameRuleStore;
 ...
 * @see EngineLevels
 */
public class RuntimeLevelConfig {
    private final GameRuleStore gameRules = new GameRuleStore();
    private long seed = 0;
    private ResourceKey<DimensionType> dimensionTypeKey = EngineLevels.DEFAULT_DIM_TYPE;
