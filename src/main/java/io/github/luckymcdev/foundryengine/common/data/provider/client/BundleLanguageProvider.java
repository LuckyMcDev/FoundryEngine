...
public class BundleLanguageProvider extends LanguageProvider {
    private final String bundleId;
    private final Bundle bundle;

    public BundleLanguageProvider(PackOutput output, Bundle bundle, String locale) {
        super(output, bundle.info().id(), locale);
        this.bundleId = bundle.info().id();
        this.bundle = bundle;
    }
    ...
    protected void addTranslations() {
        ...
        query.getFromRegistry(BuiltInRegistries.CREATIVE_MODE_TAB).forEach(tab -> {
            ...
            add("itemGroup." + bundleId + "." + path, formatTitleCase(path));
        });
