...
class RegistryTest {
	...
	private static class TestRegistry implements Registry<String, Integer> {
		...
		@Override
		public RegistryRef<String, Integer> getRef(String key) {
			return null;
		}
		...
		@Override
		public Integer getRandom(RandomSource random) {
			return null;
		}

		@Override
		public Optional<Integer> tryGet(String key) {
		...
		@Override
		public void forEach(BiConsumer<String, Integer> kvConsumer) {
			map.forEach(kvConsumer);
		}
